...
QtWebEngine::UrlSchemeHandler::UrlSchemeHandler( UBrowser::ContentProvider::Ptr contentProvider, QObject* parent )
	: QWebEngineUrlSchemeHandler( parent ),
	  m_contentProvider( contentProvider )
{
}

void QtWebEngine::UrlSchemeHandler::requestStarted( QWebEngineUrlRequestJob* request )
{
	QUrl url = request->requestUrl();
	url.setScheme( m_contentProvider->urlScheme() );

#ifdef PRINT_DEBUG
	qDebug() << "QtWebEngine.UrlSchemeHandler.requestStarted";
