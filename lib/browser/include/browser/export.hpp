...
#ifndef BROWSER_API_EXPORT_HPP
#define BROWSER_API_EXPORT_HPP
...
/**
  ...
  */
#ifndef BROWSER_API_STATIC
	#ifdef BROWSER_API_EXPORT
		#define BROWSER_API_DECL Q_DECL_EXPORT
	#else
		#define BROWSER_API_DECL Q_DECL_IMPORT
	#endif
#else
	#define BROWSER_API_DECL
#endif
