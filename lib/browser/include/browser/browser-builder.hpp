...
#include <browser/browser-types.hpp>    // Browser::Feature
...
/**
 * @brief The BrowserBuilder class provides a plugin interface for creating a
 * BrowserController instance.
 *
 * The application obtains an instance of the BrowserController class using the
 ...
 */
class BrowserBuilder : public QObject
{
	public:
		virtual ~BrowserBuilder() {}
		 ...
		 * @return
		 */
		virtual BrowserController createController(
		 ...
		 * @see BrowserController::hasOption()
		 */
		 ...
		 * @see BrowserController::hasFeature()
		 */
...
Q_DECLARE_INTERFACE(BrowserBuilder, BROWSER_BUILDER_IID)
