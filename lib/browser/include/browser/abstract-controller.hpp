...
#ifndef BROWSER_ABSTRACT_CONTROLLER_HPP
#define BROWSER_ABSTRACT_CONTROLLER_HPP
...
/**
 * @brief Partial implementation of the Browser::Controller class.
 *
 ...
 *
 */
class AbstractController : public Browser::Controller
{
		Q_OBJECT
	...
	public:
		 ...
		 *
		 * @return  Returns a pointer to the Browser::History object.
		 */
		Browser::History* history() const override;
		...
		void print(QPrinter* printer, std::function<void (bool succes)> result) override;

	protected:
		Browser::HistoryImpl* m_history;
	...
	protected slots:
		 ...
		 *
		 * This slot connects with Browser::HistoryImpl::restoreRequest() signal.
		 *
...
#endif // BROWSER_ABSTRACT_CONTROLLER_HPP
