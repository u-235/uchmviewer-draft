...
/**
 * @brief The Feature enumeration is used in the BrowserController::hasFeature()
 * method.
 */
enum Feature {
...
/**
 * @brief The Options enumeration is used in the BrowserController::hasOption()
 * method.
 */
enum Option {
...
/**
 * @brief The OpenFlag enumeration used in the BrowserController::linkClicked()
 * signal.
 */
enum OpenFlag {
