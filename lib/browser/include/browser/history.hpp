...
/**
 * @brief The Browser::HistotyItem class holds an element of browser history.
 */
struct HistoryItem
{
	QUrl    url;
...
class BROWSER_API_DECL History : public QObject
{
	...
	public:
		 ...
		 */
		virtual void add(HistoryItem item) = 0;
		 ...
		 */
		virtual const QList<HistoryItem>& items() const = 0;
		 ...
		 * history.
		 */
		virtual void setItems(const QList<HistoryItem>& items, int index = 0) = 0;
