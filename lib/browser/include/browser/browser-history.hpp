...
/**
 * @brief The BrowserHistotyItem class holds an element of browser history.
 */
...
class BROWSER_API_DECL BrowserHistory : public QObject
{
	...
	public:
		 ...
		 */
		virtual void add(BrowserHistoryItem item) = 0;
		 ...
		 */
		virtual BrowserHistoryItem& item(int index) = 0;
		 ...
		 */
		virtual BrowserHistoryItem& currentItem() = 0;
		 ...
		 */
		virtual const QList<BrowserHistoryItem>& items() const = 0;
		 ...
		 * history.
		 */
		virtual void setItems(const QList<BrowserHistoryItem>& items, int index = 0) = 0;
