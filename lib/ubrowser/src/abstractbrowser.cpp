...
{
	loadImpl( convertUrlForBrowser( ebookUrl ) );
}
...
QUrl UBrowser::AbstractBrowser::convertUrlForEbook(const QUrl &browserUrl)
{
...
QUrl UBrowser::AbstractBrowser::convertUrlForBrowser(const QUrl &ebookUrl)
{
...
void UBrowser::AbstractBrowser::onLinkClicked( const QUrl& link, OpenMode mode )
{
	...
	emit linkClicked( convertUrlForEbook( link ), mode );
}
...
void UBrowser::AbstractBrowser::onContextMenuRequested( const QPoint& globalPos, const QUrl& link )
{
	...
	emit contextMenuRequested( globalPos, convertUrlForEbook( link ) );
}
