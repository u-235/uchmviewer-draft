...
/**
 * @brief The UBrowser::Browser class provides an interface to display documents.
 *
 * The application uses the UBrowser::Browser class to display eBook pages.
 * Hereinafter the word "controller" is used to mean "the UBrowser::Browser
 ...
 *
 * The application passes a pointer to a UBrowser::ContentProvider instance to the
 * controller constructor. The UBrowser::ContentProvider class is the only way to
...
class UBROWSER_API_DECL Browser : public QObject
{
	...
	public:
		 ...
		 *
		 * If controller has not UBrowser::FEATURE_HISTORY feature, the method
		 * return @c nullptr.
		 *
		 * @return Returns a pointer to the UBrowser::History object or @c nullptr.
		 */
	...
	public:
		 ...
		 *
		 * If controller has not UBrowser::FEATURE_ZOOM feature, the method
		 * must returns 1.0.
		 *
		 * @see setZoomFactor()
		 * @see zoomDecrease()
	...
	public slots:
		 ...
		 * @see zoomFactor()
		 */
		virtual void zoomDecrease() = 0;

	public:
		/**
		 * @brief Returns the position of the scroll bar in the view window.
		 *
		 * If controller has not UBrowser::FEATURE_SCROLL feature, the method
		 * must returns @c 0.
		 *
		 ...
		 *
		 * If controller has not UBrowser::FEATURE_COPY feature, the method
		 * does nothing.
		 *
		 * @see selectedText()
		 * @see selectedCopy()
		 ...
		 *
		 * If controller has not UBrowser::FEATURE_SEARCH feature, the method
		 * does nothing.
		 *
		 ...
		 *
		 * If controller has not UBrowser::FEATURE_PRINT feature, the method
		 * does nothing.
		 *
		 * @param[in] printer Print device.
		 */
		virtual void print( QPrinter* printer, std::function<void ( bool succes )> result ) = 0;
